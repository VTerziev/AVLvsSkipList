...
void generateScenario4()
{ /// searching elements in a small set
    ofstream fout;
...
void generateScenario5()
{ /// searching elements in a large set
    ofstream fout;
...
void generateScenario6()
{ /// insert many elements then delete them
    ofstream fout;
...
void generateScenario9()
{ /// many random inserts, many random contains then many random deletes
    ofstream fout;
...
void generateScenario10()
{ /// random inserts, contains and deletes
    ofstream fout;
...
void generateScenario14()
{ /// almost inserting in increasing order
    ofstream fout;
...
void generateScenario15()
{ ///  almost inserting in decreasing order
    ofstream fout;
...
void generateScenario16()
{ /// mostly searching elements
    ofstream fout;
...
void generateScenario17()
{ /// random inserts and then delete those elements
    ofstream fout;
